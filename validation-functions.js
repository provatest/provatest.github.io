...
disable:false,
    ...
    .on('success.form.bv', function(e) {
        ...
        var url = 'https://script.google.com/macros/s/AKfycbzFmu9ty0ZUQ6TYH2AA1QksiTi3vjaUWeZnFQVlb6NXbiKFP3s/exec';
        var redirectUrl = 'success-page.html';
        // show the loading 
        $('#postForm').prepend($('<span></span>').addClass('glyphicon glyphicon-refresh glyphicon-refresh-animate'));
        var jqxhr = $.post(url, $form.serialize(), function(data) {
            console.log("Success! Data: " + data.statusText);
  $('#postForm span').removeClass('glyphicon glyphicon-refresh glyphicon-refresh-animate');
     $('#postForm').prop("disabled", false); // Element(s) are now enabled.
